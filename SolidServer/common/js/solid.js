...
(function () {
  ...
  // Add the init method to PasswordValidator
  PasswordValidator.prototype.init = function () {
    this.fetchDomNodes()
    this.bindEvents()
  }
  ...
  PasswordValidator.prototype.validatePassword = function () {
    ...
    if (!this.disablePasswordChecks) {
      ...
      this.checkLeakedPassword(password).then(this.handleLeakedPasswordResponse.bind(this)).catch(this.handleError.bind(this))
    }
  ...
  function initializePasswordValidator () {
    ...
    const repeatedPasswordField = document.getElementById('repeat_password')
    if (passwordField && repeatedPasswordField) {
      const validator = new PasswordValidator(passwordField, repeatedPasswordField)
      validator.init()
    }
  }
