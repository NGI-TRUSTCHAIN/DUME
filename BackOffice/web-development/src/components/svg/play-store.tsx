export const PlayStoreIcon = () => {
    ...
    return (
        <svg viewBox="0 -47.5 135 135" id="Layer_1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <g>
                    ...
                    <path className="st5" fill="url(#SVGID_3_)" d="M27.1 24.2L22.9 20 10.4 32.5c.5.5 1.2.5 2.1.1l14.6-8.4"></path>
                    ...
                    <path className="st6" fill="url(#SVGID_4_)" d="M27.1 15.8L12.5 7.5c-.9-.5-1.6-.4-2.1.1L22.9 20l4.2-4.2z"></path>
                    <path className="st7"
                          fill="#fff"
